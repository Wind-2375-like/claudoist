...
const seedTasks: SeedTask[] = [
  ...
  { title: '约牙医', ctx: '@phone', min: 5, energy: 'low', pri: 2, labels: ['calls'] },
  { title: '整理书桌', ctx: '@home', min: 15, energy: 'low', pri: 5, labels: ['home'] },
  { title: '已完成:配置 CI', ctx: '@computer', min: 30, energy: 'high', pri: 2, status: 'done' },
  { title: '已删除:过时想法', ctx: '@computer', min: 5, energy: 'low', pri: 5, status: 'deleted' },
];
...
const filters: [string, FilterQuery][] = [
  ...
  ['High priority next', { priorityMax: 2 }],
];
