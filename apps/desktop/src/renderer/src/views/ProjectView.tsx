  ...
  return (
    <div className="px-8 py-6">
      <div className="mb-4 flex items-baseline gap-3">
        ...
        {data.deleted && (
          <span className="rounded bg-red-50 px-1.5 py-0.5 text-xs text-red-700">在回收站</span>
        )}
        {data.deadline && (
      ...
      {data.deleted && (
        <div className="mb-4 rounded-lg border border-red-200 bg-red-50 px-3 py-2.5 text-xs text-red-800">
          ...
          <div className="mt-2 flex flex-wrap items-center gap-2">
            <button
              type="button"
              className="rounded border border-red-300 bg-white px-2.5 py-1 hover:bg-red-100"
              onClick={() => {
